...
//        String sql = "INSERT INTO  springtest.t_forum VALUES (?,?)";
...
//        String sql="INSERT INTO springtest.t_forum VALUES(NULL,?)";
...
//        String sql = "DELETE FROM springtest.t_forum WHERE forum_id=?";
//        Object[] args = {forumId};
//        return jdbcTemplate.update(sql,args);
//    }
//
